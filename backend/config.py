...
POSTGRES_HOST = os.getenv('POSTGRES_HOST', "db") # Название контейнера в docker
POSTGRES_PORT = os.getenv('POSTGRES_PORT', "5432") # 5432 по умолчанию
...
# Vision-модель OpenRouter (бесплатный эндпоинт)
